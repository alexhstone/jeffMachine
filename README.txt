...
The jeffmachine is a commandline text augmentation tool that can revoluationize the way you append .txt documents. 
...
usage:  ./jeffmachine yourFile.txt
